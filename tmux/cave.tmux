# cave
set -g @dark        "#0e0c10"   # bg1        – primary background
set -g @darker      "#130f16"   # bg2        – secondary background
set -g @darkest     "#060408"   # bg4 / void – status bar / tab bar background
set -g @dark_gray   "#3a3040"   # lnum       – line-number gray
set -g @med_gray    "#6a3a9a"   # aura       – act2 / border accent
set -g @light_gray  "#6e6458"   # ash        – base_dim
